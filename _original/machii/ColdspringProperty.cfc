...
<cfcomponent
	...
	<cffunction name="getMonolithLogger" access="private" returnType="coldspring.monolith.MonolithLogger" output="false">
			...
			<cftry>
				...
				<cfcatch type="any">
					<cfset getMonolithLogger().ThrowError(
						...
						extendedInfo=beanFactory.getBeanDefinitionList()
					) />
				</cfcatch>
			</cftry>
